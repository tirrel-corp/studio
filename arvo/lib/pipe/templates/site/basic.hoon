...
++  index-page
  ...
  ;html
    ...
    ==
    ;+  %-  frame
        :*  (header binding.si title.meta.channel.si)
            previews
  ==    ==
::
++  frame
...
++  article-preview
  ...
  ?>  ?=(%diary -.kind-data.essay.ai)
  ;a(href url, style "color: unset")
    ;*  %-  zing
    :~  ?:  =('' image.kind-data.essay.ai)  ~
        :_  ~
        ;img(src (trip image.kind-data.essay.ai), style "object-fit:cover; width: 100%; height: 200px; border-radius:10px");
    ::
        :_  ~
        ;h3(style "margin-block-end: 0.25em; margin-block-start: 0.5em"): {(trip title)}
    ::
        :_  ~
...
++  article-manx
  ...
  ;html
    ...
    ==
    ;+  (frame (article-body ai con title))
  ==
++  article-head
  |=  [ai=article-inputs con=marl title=@t]
  ^-  marl
...
++  article-body
  ...
  =/  [snippet=(unit @t) img=(unit @t)]  (new-snip essay.ai 200)
  ?>  ?=(%diary -.kind-data.essay.ai)
  :~  (header binding.ai title.meta.channel.ai)
